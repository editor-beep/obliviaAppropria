...
export const narrative: StoryDocument = {
  sections: [
    {
      id: "chapter-one-the-gilded-silence",
      title: "Chapter One: The Gilded Silence",
      blocks: [
        {
          type: "heading",
          text: "The Case of the De-Materialized Consecrated Form",
        },
        {
          type: "paragraph",
        ...
        {
          type: "document",
          label: "Global Heritage Trust — Retainer Agreement: Private Forensic Consultation",
          body: "The Global Heritage Trust, operating under UNESCO observer status, hereby retains Appropria Somatic Forensics LLC for an immediate, high-priority Auric Cartography Investigation regarding the sudden operational disappearance of the Consecrated Shakyamuni Artifact from the Swayambhu Annex. Ms. Appropria is authorized to conduct a complete vibrational scan of the inner sanctum to resolve the site's current atmospheric tension and restore investor confidence before the upcoming Q3 World Heritage compliance audit. Fee: $50,000/week plus private transport logistics. All findings proprietary.",
        },
        {
          type: "quote",
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "paragraph",
          text: "On her final morning at the Tribhuvan terminal, Oblivia sat within the premium, leather-appointed interior of her chartered private jet, her fountain pen gliding over heavy, linen-bound paper with an unshakeable, spiritual confidence.",
        },
        {
          type: "document",
