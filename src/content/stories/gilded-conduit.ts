...
export const narrative: StoryDocument = {
  sections: [
    {
      id: "chapter-one-black-honey",
      title: "Chapter One: Black Honey",
      blocks: [
        {
          type: "heading",
    ...
    {
      id: "chapter-two-the-music-in-the-pressure",
      title: "Chapter Two: The Music in the Pressure",
      blocks: [
        {
          type: "paragraph",
    ...
    {
      id: "chapter-three-the-meridian-reclamation",
      title: "Chapter Three: The Meridian Reclamation",
      blocks: [
        {
          type: "paragraph",
